...
// - Add option to auto-track battles fought in

// 0.6
// - Add auto tracking in fought battle option
...
(function () {
    ...
    let battletracker_autotrack_fought = localStorage.getItem("battletracker_autotrack_fought");
    if (battletracker_autotrack_fought == null) {
        battletracker_autotrack_fought = "false"
        localStorage.setItem("battletracker_autotrack_fought", battletracker_autotrack_fought);
    }
    ...
    function add_battle_info(response, statsbattles, statsdivs) {
        ...
        let autotrack = localStorage.getItem("battletracker_autotrack_fought");
        if (autotrack === "true") {
            for (let j = 0; j < statsbattles.length; j++) {
                battletracker_battle_ids.push(String(statsbattles[j]));
            }
        }
